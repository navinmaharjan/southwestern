    ...
    <>
      <div>
        <div className="grid grid-cols-3 relative w-full group">
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-20 transition-all duration-300 group-hover:opacity-0">
            <div className="flex flex-col uppercase text-white items-start">
              <h3 className=" text-2xl md:text-3xl font-bold">Life At</h3>
              <h1 className=" text-4xl md:text-7xl font-extrabold text-start tracking-wide text-orange">
                Southwestern
              </h1>
            </div>
          </div>
