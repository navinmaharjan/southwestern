      ...
      >
        {BannerData.map((item, index) => (
          <SwiperSlide key={index}>
            <div className="relative w-full h-[380px] sm:h-[600px]">
              ...
              <div className="absolute top-1/2 left-1/3 -translate-x-1/2 -translate-y-1/2 w-1/2">
                <div className="flex flex-col uppercase text-white items-start justify-start">
                  <h3 className="text-xl sm:text-3xl font-bold">Welcome to</h3>
                  <h1 className="text-4xl sm:text-7xl font-extrabold text-start tracking-wide">
                    Southwestern School
                  </h1>
                  <h3 className="sm:text-xl font-bold text-orange tracking-wider">
