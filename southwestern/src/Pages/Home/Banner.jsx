        ...
        {BannerData.map((item, index) => (
          <SwiperSlide key={index}>
            <div className="relative w-full h-[600px]">
              ...
              <div className="fixed top-0 right-0 w-32 h-14">
                <img src={Logo2} alt="" />
              </div>
              <div className="absolute top-1/2 left-1/3 -translate-x-1/2 -translate-y-1/2 w-1/2">
                <div className="flex flex-col uppercase text-white items-start justify-start">
                  ...
                  <h1 className="text-7xl font-extrabold text-start tracking-wide">
                    Southwestern School
                  </h1>
                  <h3 className="text-xl font-bold text-orange tracking-wider">
