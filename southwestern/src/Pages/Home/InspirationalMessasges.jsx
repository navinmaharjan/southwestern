          ...
          <div className="w-full flex justify-center items-center">
            <div className="container mx-auto py-16">
              <div className="grid grid-cols-3 gap-4 items-center">
                ...
                <div className="flex justify-center items-center flex-col w-[480px] shadow-xl  pt-4">
                  <div className="relative w-[400px] h-60">
                ...
                <h3 className="text-2xl font-semibold bg-orange text-white py-4 px-8 text-center">
