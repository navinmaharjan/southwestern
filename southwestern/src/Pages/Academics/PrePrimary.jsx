      ...
      <div className="container mx-auto py-4 xl:py-16">
        <div className="flex justify-center items-center">
          <div className="flex flex-col gap-4 xl:w-2/3 ">
            ...
            <p className="text-sm sm:text-base">At SWS, we strive to provide your child with a safe and caring place to learn, grow, and have fun. Our goal is to help your child develop a positive attitude towards learning through the time-tested Montessori Method and Early Childhood Education.</p>
            <div className="flex flex-col gap-3">
              {PrePrimaryData.map((item, index) => (
                <div key={index}>
                  <p className="text-justify text-slate-700 font-semibold text-sm sm:text-base">{item.heading}</p>
